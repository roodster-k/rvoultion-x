  ...
  return (
    <>
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(180px,1fr))] gap-4 mb-8">
        <div className="bg-primary-light rounded-[20px] p-6 shadow-card hover:shadow-card-hover transition-shadow">
        ...
        <div className="bg-status-attention-bg rounded-[20px] p-6 shadow-card hover:shadow-card-hover transition-shadow">
